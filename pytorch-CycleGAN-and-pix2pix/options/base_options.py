...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='labeled', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        parser.add_argument('--direction', type=str, default='AtoB', help='AtoB or BtoA')
        parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading data')
        parser.add_argument('--batch_size', type=int, default=64, help='input batch size')
        parser.add_argument('--load_size', type=int, default=28, help='scale images to this size')
        parser.add_argument('--crop_size', type=int, default=28, help='then crop to this size')
        ...
        parser.add_argument('--display_winsize', type=int, default=32, help='display window size for both visdom and HTML')
