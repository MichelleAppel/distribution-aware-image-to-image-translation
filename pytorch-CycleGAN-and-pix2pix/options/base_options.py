...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ratio_A', type=float, default=0.2, help='the ratio 0 to 1 in domain A')
        ...
        parser.add_argument('--batch_size', type=int, default=56, help='input batch size')
